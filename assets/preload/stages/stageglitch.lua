function onCreate()
	-- background shit
	makeLuaSprite('stageglitch', 'stageglitch', -600, -300);
    ...
    makeLuaSprite('CameraShtuff', 'CameraShtuff', -1000, -300);
    setLuaSpriteScrollFactor('CameraShtuff', 0.9, 0.9);
    scaleObject('CameraShtuff', 1.6, 1.6);
